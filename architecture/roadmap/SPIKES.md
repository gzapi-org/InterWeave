...
Fifteen findings constrain Stage 10. The first is a sequencing constraint rather than a detail, and three more say the gate cannot be written the obvious way:
