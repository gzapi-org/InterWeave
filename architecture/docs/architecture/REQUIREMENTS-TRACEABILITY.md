...
| implementation repository/test placement | ADR-0045, `docs/architecture/implementation-repository-layout.md`, repository-root `apps/`, `crates/`, `tests/`, `fixtures/`, `spikes/` |
