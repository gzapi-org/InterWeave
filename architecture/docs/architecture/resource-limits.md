...
| AutoNAT server concurrent probes | 8 | 64 | refuse the request before the crate examines it (`refused_concurrent_probes`); the client's crate treats the answer as transient |
