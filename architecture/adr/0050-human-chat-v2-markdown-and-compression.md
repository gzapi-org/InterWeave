...
2. **`text` is markdown.** The content of `kind: "text"` is CommonMark, plus the table and strikethrough extensions; the exact pinned grammar and bounds live in the v2 revision of `clients/human/HUMAN-CHAT.md`. Non-negotiable subset rules, wire-visible and consumer-visible:
