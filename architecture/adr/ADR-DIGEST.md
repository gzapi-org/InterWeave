...
| address class, SSRF boundary, peer-supplied address, dial-back target, hole punch candidates, loopback, link-local, RFC 1918, ULA | **0052** (+ 0035 the two instances' protocols, 0036 the trust it does not substitute for) |
...
- Keywords: address class, SSRF boundary, peer-supplied address, dial-back target, hole punch candidates, loopback, link-local, RFC 1918, ULA, pending outbound hook, is_probeable_address, resolver policy, peer-supplied name, identify listen_addrs, learn site
