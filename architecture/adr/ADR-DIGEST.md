...
- Keywords: connectionmanager, dialadmissiongate, behaviour-originated dial, address quarantine, identity mismatch, poisoned address, backoff, address book, newexternaladdrofpeer, discovery never writes the book
