...
- Keywords: connectionmanager, dialadmissiongate, behaviour-originated dial, address quarantine, identity mismatch, poisoned address, backoff, address book, newexternaladdrofpeer, discovery never writes the book, identify listen_addrs, identify cache, store hook
...
- Keywords: address class, SSRF boundary, peer-supplied address, dial-back target, hole punch candidates, loopback, link-local, RFC 1918, ULA, pending outbound hook, is_probeable_address, resolver policy, peer-supplied name, identify listen_addrs, learn site, root funnel, extend_addresses_through_behaviour, store versus dial, operator set, provenance door, AddAddress, identify cache
