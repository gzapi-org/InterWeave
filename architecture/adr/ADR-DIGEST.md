...
- Keywords: address class, SSRF boundary, peer-supplied address, dial-back target, hole punch candidates, loopback, link-local, RFC 1918, ULA, pending outbound hook, is_probeable_address
