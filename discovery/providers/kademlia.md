...
DHT poisoning, Sybil/eclipsing, stale addresses, privacy leakage, bootstrap capture, and network partitions. Mitigations include trust-gated data delivery, bounded query rates, peer diversity, multiple independent bootstrap hints, candidate caps, and future peer scoring/diversity policies.
