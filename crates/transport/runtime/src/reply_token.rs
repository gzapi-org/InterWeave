...
impl ReplyTokenTable {
    ...
    pub fn mint(&mut self, token: impl Into<String>, route: ReplyRoute, now_ms: u64) {
        self.expire(now_ms);
...
mod tests {
    ...
    fn the_table_is_bounded_and_evicts_oldest_first() {
        ...
        t.mint("a", direct_route("e"), 0);
        t.mint("b", direct_route("e"), 1);
        t.mint("c", direct_route("e"), 2);
        assert_eq!(t.len(), 2);
        assert_eq!(
