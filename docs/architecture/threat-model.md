...
| remote sender attempts to force message persistence | human application retention | Keep is receiver-local, available only after read; HumanChatV1 has no persistence request field | compromised human client can violate its own local policy |
