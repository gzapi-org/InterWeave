...
- Stages 0-10 are **complete** and **Stage 11 is open**. SPIKE-004's
  ...
  **three** routes to one; step 3's adapter reaches routes 2 and 3 (see
  ...
  1. **A WRAPPED BEHAVIOUR whose classifier announces one.** The
     ...
     the announced path meanwhile, and is retired once the punched
     direct is stable), `DialPeer` dialling direct first and a circuit
     route only after the 750 ms head-start. What stands between a punch
